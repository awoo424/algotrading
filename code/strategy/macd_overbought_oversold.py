...
"""
Moving Average Convergence Divergence (MACD) overbought & oversold
-
Buy when MACD falls dramatically, (oversold)
sell when MACD rises rapidly. (overbought)
"""
class macdOverboughtOversold():
